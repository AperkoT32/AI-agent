...
Велинец Даниил - реализовал ключевой компонент взаимодействия с AI-агентом: оптимизировал системный промпт, тестирование агента на неточности и ошибки и их исправление, разработка фильтра вывода текста ИИ-агента, провёл логирование для удобной отладки.
