Для быстрого запуска нужно воспользоваться батником под названием launch и смотреть пункт 5) и 6). Если хотите идти по сложному пути (установка вручную), то сначала:

1. В cmd терминале (будучи в папке агента) пишите: IDL python -m venv .venv (===Создание виртуального окружения===)
2. В том же терминале пишем: venv\Scripts\activate (===Активация виртуального окружения===)
